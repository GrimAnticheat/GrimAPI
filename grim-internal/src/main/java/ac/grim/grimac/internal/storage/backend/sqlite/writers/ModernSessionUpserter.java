...
final class ModernSessionUpserter implements SessionUpserter {
    ...
    public void addBatch(UUID sessionId,
        ...
        upsert.setString(6, grimVersion);
        upsert.setString(7, clientBrand);
        upsert.setInt(8, clientVersionPvn);
        upsert.setString(9, serverVersionString);
        upsert.setString(10, replayClipsJson);
        upsert.addBatch();
    }
